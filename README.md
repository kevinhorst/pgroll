...
<p align="center">
  <a href="https://github.com/kevinhorst/pgroll/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-Apache_2.0-green" alt="License - Apache 2.0"></a> &nbsp;
  <a href="https://github.com/kevinhorst/pgroll/actions?query=branch%3Amain"><img src="https://github.com/kevinhorst/pgroll/actions/workflows/build.yml/badge.svg" alt="CI Build"></a> &nbsp;
  <a href="https://github.com/kevinhorst/pgroll/releases"><img src="https://img.shields.io/github/release/xataio/pgroll.svg?label=Release" alt="Release"></a> &nbsp;
...
Binaries are available for Linux, macOS & Windows, check our [Releases](https://github.com/kevinhorst/pgroll/releases).
...
* Create an [issue](https://github.com/kevinhorst/pgroll/issues) for any questions, bug reports, or feature requests.
* Check the documentation and [existing issues](https://github.com/kevinhorst/pgroll/issues) before opening a new issue.
