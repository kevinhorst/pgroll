...
Assuming that the [example migrations](https://github.com/kevinhorst/pgroll/tree/main/examples) have been applied to the `public` schema in the target database, running:
...
Assuming that the [example migrations](https://github.com/kevinhorst/pgroll/tree/main/examples) are on disk in a directory called `examples`, running:
