...
Assuming that migrations up to and including migration `40_create_enum_type` from the [example migrations](https://github.com/kevinhorst/pgroll/tree/main/examples) directory have been applied, running:
